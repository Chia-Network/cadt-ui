              ...
              <StyledFieldContainer>
                ...
                <InputContainer>
                  <Select
                    ...
                    variant={
                      selectedWayToAddLabel === null && SelectVariantEnum.error
                    }
                    selected={
                      selectedWayToAddLabel
                        ? [selectedWayToAddLabel]
            ...
            <>
              ...
              <StyledFieldContainer>
                ...
                <InputContainer>
                  <SimpleSelect
                    variant={
                      valueErrors?.labelType &&
                      valueTouched?.labelType &&
              ...
              <SpanTwoColumnsContainer>
                <StyledFieldContainer>
                  ...
                  <StandardInput
                    variant={
                      valueErrors?.labelLink &&
                      valueTouched?.labelLink &&
                      InputVariantEnum.error
                    }
                    size={InputSizeEnum.large}
                    placeholderText={intl.formatMessage({
              ...
              <StyledFieldContainer>
                ...
                <InputContainer>
                  <DateSelect
                    variant={
                      valueErrors?.validityPeriodStartDate &&
                      valueTouched?.validityPeriodStartDate &&
              ...
              <StyledFieldContainer>
                ...
                <InputContainer>
                  <DateSelect
                    variant={
                      valueErrors?.validityPeriodEndDate &&
                      valueTouched?.validityPeriodEndDate &&
                      DateVariantEnum.error
                    }
                    size="large"
              ...
              <StyledFieldContainer>
                ...
                <InputContainer>
                  <DateSelect
                    variant={
                      valueErrors?.creditingPeriodStartDate &&
                      valueTouched?.creditingPeriodStartDate &&
                      DateVariantEnum.error
                    }
                    size="large"
              ...
              <StyledFieldContainer>
                ...
                <InputContainer>
                  <DateSelect
                    variant={
                      valueErrors?.creditingPeriodEndDate &&
                      valueTouched?.creditingPeriodEndDate &&
                      DateVariantEnum.error
                    }
                    size="large"
              ...
              <StyledFieldContainer>
                ...
                <InputContainer>
                  <StandardInput
                    variant={
                      valueErrors?.unitQuantity &&
                      valueTouched?.unitQuantity &&
                      InputVariantEnum.error
                    }
                    type="number"
                    size={InputSizeEnum.large}
